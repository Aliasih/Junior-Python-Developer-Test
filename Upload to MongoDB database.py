...
client = pymongo.MongoClient("mongodb+srv://Aliasih:<password>@cluster0.9qcjno9.mongodb.net/?retryWrites=true&w=majority")

# Replace <database-name> and <collection-name> with the name of your database and collection
db = client['<Python>']
collection = db['<Code>']
